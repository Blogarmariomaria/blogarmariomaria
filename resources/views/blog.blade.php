...
<div>    
            ...
            <div class="content">
                ...
                <nav><ul>
                    <li><a href="{{ url('blog') }}">Inicio</a></li>
        ...
        <figure class="wp-block-image">
            <img src="{{ asset('imagenes/fotos/habitacion.jpg') }}" alt="" width="500" height="550">
        </figure>
        <ul>
            <li>
...
            y me enamoré de todas las ideas. No ha sido fácil últimamente con este blog, he tenido
            todos los problemas que puedas imaginar. Todo, desde ser pirateado hasta un diseño desordenado.
...
            el editor ha desaparecido de mi panel de WordPress y todo el código que había hecho hace unos años
            también había desaparecido, pero todo volvió a la normalidad. (O en realidad mejor, hecho
            algunos cambios aquí y allá.) Tengo que agradecer a mi servidor Zoner por ayudarme con todo tipo
            de problemas
            </li>
        </ul>
        <figure class="wp-block-image"><img src="{{ asset('imagenes/fotos/habitacion.jpg') }}" alt="" width="500" height="550">
        </figure>
        <figure class="wp-block-image"><img src="{{ asset('imagenes/fotos/habitacion.jpg') }}" alt="" width="500" height="550">
        </figure>
        <ul><li><strong>Mi proyecto</strong>
        . Nuestra temporada de podcasts "Yksillä" 4.
         Este proyecto se ha vuelto más grande de lo que esperaba hace años, 
         cuando comenzamos a grabar los primeros episodios con nuestros teléfonos
         simplemente sentados en una cama, con la esperanza de que no hubiera demasiado
         ruido de fondo. (Siempre hubo). La primera actualización fue hacerlo en un estudio 
         adecuado con un buen equipo. La segunda actualización nos lleva mucho tiempo para planificar 
         el contenido. e invertir más en la cuenta de podcast de Instagram. Tercero, elegir socios de 
         colaboración, que sentimos encajar en nuestros temas, etc. Ha sido muy divertido desarrollar
         a nuestro bebé y escuchar que el número de oyentes está en constante crecimiento. 
         ...
         <ul>
           ...
           llamada Accenture. Al princio todo fue un caos puesto que salia de mi de ciclo formativo 
           Desarrollo de Aplicaciones Multiplataforma.
           Con el paso del tiempo me hice a mi proyecto(cosa que mis compañeros me lo pusieron muy facil)
