...
<div>    
        ...
        <h1 class="entry-title" itemprop="headline">Acerca de</h1>
        <div class="entry-content" itemprop="text">
            <p style="text-align: center;padding-left:10%;padding-right: 10%">
            Maria Acosta Prieto, 23 años,fundadora del blog, soy una blogger
            a tiempo parcial, puesto que actualmente soy programadora,
            que vive en un pueblo de León. 
            Le apasiona la fotografia, escribir, leer y la moda.</p>
            <p style="text-align: center;">
                <img class="aligncenter wp-image-33212 size-full" src="{{ asset('imagenes/fotos/puesta.jpg') }}" alt="" width="500" height="550" >
            </p>
        </div>
<!--INSTAGRAM-->
<div class="instagram">
